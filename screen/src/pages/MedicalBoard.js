...
import MedicalBoardCard from './MedicalBoard_Card';
import MedicalBoardRecent from './MedicalBoard_Recent';
import './css/MedicalBoard.css';
const { useState} = React;

const MedicalBoard = () => {
    const [data1] = useState({type : "화상 진단기록", date : "2020/09/15", imgSrc : require('./icon/doctor.svg'),
        text1: "댕케어 동물병원", text2: "김호준 수의사", text3: "간 수치가 높은 편입니다. 지방 많은 음식을 주지 마세요."});
    const [data2] = useState({type : "AI 진단기록", date : "2020/09/02", imgSrc : require('./icon/chatbot.svg'),
